...
- Within Foundational: T009 and T011 run in parallel with each other and with the T004→T008 chain; T012 (`adapt()`) can start once T001 and T008 land (not T004 alone — see T012's own dependency note).
